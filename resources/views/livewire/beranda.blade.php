<div class="justify-center my-8">
    ...
    <div class="max-w-7xl h-64 w-full items-center rounded overflow-hidden shadow-lg px-5 py-3 md:mx-auto border justify-center">
        <div class="max-w-7xl w-full md:mx-auto my-2">
            <div class="grid grid-cols-5 gap-4">
                ...
                <div class="border p-4 relative flex flex-col items-center">
                    ...
                    <img src="{{ asset('storage/post-images/' . $book->image_featured) }}" alt="Cover Buku" class="mb-2">
